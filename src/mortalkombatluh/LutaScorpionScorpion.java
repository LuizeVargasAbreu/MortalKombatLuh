...
public class LutaScorpionScorpion {
    
    private String cenario;
    private Scorpion personagem1;
    ...
    public Scorpion getPersonagem1() {
        return personagem1;
    }

    public void setPersonagem1(Scorpion personagem1) {
    ...
    public void setDanocombo(Integer danocombo) {
        ...
        public LutaScorpionScorpion ()
    {
        this.cenario = "Casa do Goro";
        this.personagem1 = new Scorpion ();
